...
class App:
    ...
    def submit(self):
        ...
        if self.var1.get() and not self.var2.get():
            msg = f"{name.upper()}'s data will be collected from MoneyControl website please press scrape to continue."
            #t.sleep(10)
        ...
        #only screener
            ...
            msg = f"{name.upper()}'s data will be collected from Screener website please press scrape to continue."
            label = tk.Label(self.new_window1, text=msg, font=("Arial", 12))
            label.pack(pady=10)
            # Create buttons to initiate scrape
            self.scrape1 = tk.Button(self.new_window1, text="scrape", font=("Arial", 12), bg="#3498DB",
        ...
        # scrape using moneycontrol and screener
            ...
            msg = f"{name}'s data will be collected from MoneyControl website and screener website please press " \
        ...
        #just does nothing
            ...
            msg = f"you haven't chose any option, you can look out for pre-existing files."
            label = tk.Label(self.new_window1, text=msg, font=("Arial", 12))
            label.pack(pady=10)
            self.ok = tk.Button(self.new_window1, text="ok", font=("Arial", 12), bg="#3498DB",
                                fg="white",
        ...
        label.pack(pady=10)
        self.button1 = tk.Button(self.new_window2, text="open moneycontrol data file location", font=("Arial", 12), bg="#3498DB", fg="white",
                                 command=self.open_MC)
        self.button2 = tk.Button(self.new_window2, text="Open screener data file location", font=("Arial", 12), bg="#3498DB", fg="white",
